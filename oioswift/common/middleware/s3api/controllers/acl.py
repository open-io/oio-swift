...
from oioswift.common.middleware.s3api.exception import ACLError
...
from oioswift.common.middleware.s3api.response import HTTPOk, \
    S3NotImplemented, MalformedACLError, UnexpectedContent, \
    MissingSecurityHeader
from oioswift.common.middleware.s3api.etree import Element, SubElement, \
    tostring
from oioswift.common.middleware.s3api.acl_utils import swift_acl_translate, \
    XMLNS_XSI
